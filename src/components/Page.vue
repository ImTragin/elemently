<template>
<div>
    <div v-if="hasHeaderImage()" class="Page-Header" :style="getPageHeaderStyling()" />
    <component v-for="({ sectionComponent, content }, index) in PageSections" :is="sectionComponent" :key="index" :Section="content" />
</div>
</template>
