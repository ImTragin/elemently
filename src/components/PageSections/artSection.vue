...
<div class="art-section">
    ...
    <div v-for="(column, index) in Section.columns" class="art-section-column" :key="index">
        <img class="artwork" v-for="(item, index) in Section.columns" :key="index" :src="getURL(trueIndex(index, column))" :alt="getAlt(trueIndex(index, column))" @click="click(trueIndex(index, column))" />
    </div>
</div>
</template>
